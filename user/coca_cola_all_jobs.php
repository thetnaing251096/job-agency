...
<?php
$sql = "SELECT  * FROM jobs WHERE categories_id = (SELECT id FROM categories WHERE name = 'coca cola')";
$query = mysqli_query($conn, $sql);
?>


<section class="jobs-home-coca-cola">
    <div class="jobs-content">
    </div>
    <div class="jobs-content-title row justify-content-center bg-light shadow-sm">
        <div class=" col-lg-3 col-md-12 col-sm-12 text-center">
            <img class="img" src="../img/coca_cola.jpg" width="150px""alt="">
           </div>
           <div class=" col-lg-9 col-md-12 col-sm-12">
            <p>Address : Coca Cola Pinya Mfrg. Co., Ltd. is mainly provides Beverages - Manufacturers and Distributors. It is located at 37-38, Bamaw A-twinn-wun St., Ind. Zone (3), Hlaing Thayar.Tsp, Yangon </p>
            <p>PH : 09 775098445</p>
            <p>Industry : FMCG company</p>
        </div>
    </div>
</section>
...
<section class="jobs-view container">
    <div class="row">
        <div class=" mt-5 jobs-border">
            <h2>Coca Cola All Jobs</h2>
        </div>
        <div class=" d-flex border border-1 shadow-sm p-3 m-2 align-items-center row my-3 detail-bg">
