...
<?php
$sql = "SELECT  * FROM jobs WHERE categories_id = (SELECT id FROM categories WHERE name = 'myanmar net')";
$query = mysqli_query($conn, $sql);
?>


<section class="jobs-home-myanmar-net">
    <div class="jobs-content">
    </div>
    <div class="jobs-content-title row justify-content-center bg-light shadow-sm">
        <div class=" col-lg-3 col-md-12 col-sm-12 text-center">
            <img class="img" src="../img/myanmarnet-logo.png" width="150px""alt="">
           </div>
           <div class=" col-lg-9 col-md-12 col-sm-12">
            ...
            <p>PH : 09 775098427</p>
            <p>Industry : Wi-Fi Service Company</p>
        </div>
    </div>
</section>
