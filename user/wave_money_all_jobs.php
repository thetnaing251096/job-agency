...
<?php
$sql = "SELECT  * FROM jobs WHERE categories_id = (SELECT id FROM categories WHERE name = 'wave money')";
$query = mysqli_query($conn, $sql);
?>


<section class="jobs-home-wave">
    <div class="jobs-content">
    </div>
    <div class="jobs-content-title row justify-content-center bg-light shadow-sm">
        <div class=" col-lg-3 col-md-12 col-sm-12 text-center">
            <img class="img" src="../img/wave.jpg" width="150px""alt="">
           </div>
