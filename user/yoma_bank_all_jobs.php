...
<?php 
    $sql = "SELECT  * FROM jobs WHERE categories_id =(SELECT id FROM categories WHERE name = 'yoma bank')";
...
<section class="jobs-home">
    ...
    <div class="jobs-content-title row justify-content-center bg-light shadow-sm">
           <div class=" col-lg-3 col-md-12 col-sm-12 text-center">
                <img class="img" src="../img/yoma-logo.png" "alt="">
           </div>
           <div class="col-lg-9 col-md-12 col-sm-12">
                <h4></h4>
                <p>Address : No.14, Kyaik Khauk Pagoda Road Star City, Thanlyin Township</p>
                <p>PH : 09 796645667</p>
                <p>Industry : Banking Company</p>
           </div>
    </div>
</section>
