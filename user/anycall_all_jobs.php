...
<?php
$sql = "SELECT  * FROM jobs WHERE categories_id =(SELECT id FROM categories WHERE name = 'any call mobile')";
// $sql = "SELECT id FROM categories WHERE name = 'any call mobile' ";
$query = mysqli_query($conn, $sql);
?>


<section class="jobs-home-anycall">
    <div class="jobs-content">
    </div>
    <div class="jobs-content-title row justify-content-center bg-light shadow-sm">
        <div class=" col-lg-3 col-md-12 col-sm-12 text-center">
            <img class="img" src="../img/anycall.png" width="150px""alt="">
           </div>
           <div class=" col-lg-9 col-md-12 col-sm-12">
            ...
            <p>PH : 09 775098427</p>
            <p>Industry : Mobile Sales Company</p>
        </div>
    </div>
</section>
